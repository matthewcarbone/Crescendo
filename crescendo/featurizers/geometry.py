...
_spread_map = {
    "H": 0.53, "C": 0.67, "N": 0.56, "O": 0.48, "F": 0.42, "S": 0.88
}
...
class PdfFeaturizer:
    ...
    def featurize(
        ...
        royalsocietypublishing.org/doi/full/10.1098/rsta.2018.0413#d3e1147
        ...
        ----------
        xyz : np.ndarray
            An N x d array (d is the dimension, usually 3) of the atom
            locations.
        elements : List[str]
